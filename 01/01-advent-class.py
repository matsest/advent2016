...
def main():
    ...
    print "Current direction: ", santas_helper.current_dir_id
    ...
    for direction in dirs.strip().split(', '):
        ...
        santas_helper.move(santas_helper.current_dir_id, length)

        print "Current direction: ", directions[santas_helper.current_dir_id]
        print "Current position: ", santas_helper.position
        print "\n"

    print "Length from start: ", abs(santas_helper.position[0]) + abs(santas_helper.position[1])
